...
B.mountExternalData=(a,b)=>{(B.Fb||(B.Fb=new Map)).set(a,b)};B.unmountExternalData=()=>{delete B.Fb};var SharedArrayBuffer=globalThis.SharedArrayBuffer??(new WebAssembly.Memory({initial:0,maximum:0,shared:!0})).buffer.constructor;"use strict";
let ta=()=>{const a=(c,d,f)=>(...g)=>{const k=F,l=d?.();g=c(...g);const p=d?.();l!==p&&(c=p,f(l),d=f=null);return F!=k?sa():g},b=c=>async(...d)=>{try{if(B.Eb)throw Error("Session already started");const f=B.Eb={bc:d[0],errors:[]},g=await c(...d);if(B.Eb!==f)throw Error("Session mismatch");B.Mb?.flush();const k=f.errors;if(0<k.length){let l=await Promise.all(k);l=l.filter(p=>p);if(0<l.length)throw Error(l.join("\n"));}return g}finally{B.Eb=null}};B._OrtCreateSession=a(B._OrtCreateSession,()=>B._OrtCreateSession,
...
if(E){var Fa;if(D){var Ga=ra.parentPort;Ga.on("message",b=>onmessage({data:b}));Object.assign(globalThis,{self:global,importScripts:()=>{},postMessage:b=>Ga.postMessage(b),performance:global.performance||{now:Date.now}})}var Ha=!1;H=function(...b){b=b.join(" ");D?fs.writeSync(2,b+"\n"):console.error(b)};self.alert=function(...b){postMessage({Lb:"alert",text:b.join(" "),mc:Ia()})};B.instantiateWasm=(b,c)=>new Promise(d=>{Fa=f=>{f=new WebAssembly.Instance(f,Ja());c(f);d()}});self.onunhandledrejection=
b=>{throw b.reason||b;};function a(b){try{var c=b.data,d=c.cmd;if("load"===d){let f=[];self.onmessage=g=>f.push(g);self.startWorker=()=>{postMessage({cmd:"loaded"});for(let g of f)a(g);self.onmessage=a};for(const g of c.handlers)if(!B[g]||B[g].proxy)B[g]=(...k)=>{postMessage({Lb:"callHandler",kc:g,args:k})},"print"==g&&(Ea=B[g]),"printErr"==g&&(H=B[g]);m=c.wasmMemory;u();Fa(c.wasmModule)}else if("run"===d){Ka(c.pthread_ptr,0,0,1,0,0);La(c.pthread_ptr);Ma();Na();Ha||(Oa(),Ha=!0);try{Pa(c.start_routine,
c.arg)}catch(f){if("unwind"!=f)throw f;}}else"cancel"===d?Ia()&&Qa(-1):"setimmediate"!==c.target&&("checkMailbox"===d?Ha&&Ra():d&&(H(`worker: received unknown command ${d}`),H(c)))}catch(f){throw Sa(),f;}}self.onmessage=a}var Ta;B.wasmBinary&&(Ta=B.wasmBinary);var m,Ua,I=!1,Va,q,ba,da,fa,ha,ia,ka,J,Wa,ma;
function u(){var a=m.buffer;B.HEAP8=q=new Int8Array(a);B.HEAP16=da=new Int16Array(a);B.HEAPU8=ba=new Uint8Array(a);B.HEAPU16=fa=new Uint16Array(a);B.HEAP32=ha=new Int32Array(a);B.HEAPU32=ia=new Uint32Array(a);B.HEAPF32=ka=new Float32Array(a);B.HEAPF64=ma=new Float64Array(a);B.HEAP64=J=new BigInt64Array(a);B.HEAPU64=Wa=new BigUint64Array(a)}
if(!E){m=new WebAssembly.Memory({initial:256,maximum:65536,shared:!0});if(!(m.buffer instanceof SharedArrayBuffer))throw H("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),D&&H("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");u()}
...
function Ja(){kb={M:lb,za:mb,b:nb,$:ob,z:pb,pa:qb,X:rb,Z:sb,qa:tb,na:ub,ga:vb,ma:wb,J:xb,Y:yb,V:zb,oa:Ab,W:Bb,va:Cb,D:Db,P:Eb,O:Fb,C:Gb,s:Hb,p:Ib,E:Jb,y:Kb,Q:Lb,ta:Mb,ja:Nb,T:Ob,aa:Pb,F:Qb,ia:La,sa:Rb,u:Sb,B:Tb,o:Ub,m:Vb,c:Wb,n:Xb,k:Yb,Aa:Zb,r:$b,f:ac,v:bc,l:cc,g:dc,i:ec,j:fc,h:gc,e:hc,da:ic,ea:jc,fa:kc,ba:lc,ca:mc,S:nc,d:oc,N:pc,G:qc,K:rc,w:sc,ra:tc,U:uc,t:vc,x:wc,L:xc,R:yc,ya:zc,xa:Ac,ka:Bc,la:Cc,_:Dc,A:Ec,I:Fc,ha:Gc,H:Hc,a:m,wa:Ic,ua:Jc,q:Kc};return{a:kb}}
var Lc={848436:(a,b,c,d)=>{if("undefined"==typeof B||!B.Fb)return 1;a=K(a>>>0);a.startsWith("./")&&(a=a.substring(2));a=B.Fb.get(a);if(!a)return 2;b>>>=0;c>>>=0;d>>>=0;if(b+c>a.byteLength)return 3;try{return w().set(a.subarray(b,b+c),d>>>0),0}catch{return 4}},848937:()=>{B.Ub()},848968:()=>{B.Vb()},848997:()=>{B.Zb()},849022:a=>B.Tb(a),849055:a=>B.Xb(a),849087:(a,b,c)=>{B.Nb(a,b,c,!0)},849126:(a,b,c)=>{B.Nb(a,b,c)},849159:()=>"undefined"!==typeof wasmOffsetConverter,849216:a=>{B.jb("Abs",a,void 0)},
849267:a=>{B.jb("Neg",a,void 0)},849318:a=>{B.jb("Floor",a,void 0)},849371:a=>{B.jb("Ceil",a,void 0)},849423:a=>{B.jb("Reciprocal",a,void 0)},849481:a=>{B.jb("Sqrt",a,void 0)},849533:a=>{B.jb("Exp",a,void 0)},849584:a=>{B.jb("Erf",a,void 0)},849635:a=>{B.jb("Sigmoid",a,void 0)},849690:(a,b,c)=>{B.jb("HardSigmoid",a,{alpha:b,beta:c})},849769:a=>{B.jb("Log",a,void 0)},849820:a=>{B.jb("Sin",a,void 0)},849871:a=>{B.jb("Cos",a,void 0)},849922:a=>{B.jb("Tan",a,void 0)},849973:a=>{B.jb("Asin",a,void 0)},
850025:a=>{B.jb("Acos",a,void 0)},850077:a=>{B.jb("Atan",a,void 0)},850129:a=>{B.jb("Sinh",a,void 0)},850181:a=>{B.jb("Cosh",a,void 0)},850233:a=>{B.jb("Asinh",a,void 0)},850286:a=>{B.jb("Acosh",a,void 0)},850339:a=>{B.jb("Atanh",a,void 0)},850392:a=>{B.jb("Tanh",a,void 0)},850444:a=>{B.jb("Not",a,void 0)},850495:(a,b,c)=>{B.jb("Clip",a,{min:b,max:c})},850564:a=>{B.jb("Clip",a,void 0)},850616:(a,b)=>{B.jb("Elu",a,{alpha:b})},850674:a=>{B.jb("Relu",a,void 0)},850726:(a,b)=>{B.jb("LeakyRelu",a,{alpha:b})},
850790:(a,b)=>{B.jb("ThresholdedRelu",a,{alpha:b})},850860:(a,b)=>{B.jb("Cast",a,{to:b})},850918:a=>{B.jb("Add",a,void 0)},850969:a=>{B.jb("Sub",a,void 0)},851020:a=>{B.jb("Mul",a,void 0)},851071:a=>{B.jb("Div",a,void 0)},851122:a=>{B.jb("Pow",a,void 0)},851173:a=>{B.jb("Equal",a,void 0)},851226:a=>{B.jb("Greater",a,void 0)},851281:a=>{B.jb("GreaterOrEqual",a,void 0)},851343:a=>{B.jb("Less",a,void 0)},851395:a=>{B.jb("LessOrEqual",a,void 0)},851454:(a,b,c,d,f)=>{B.jb("ReduceMean",a,{keepDims:!!b,
noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},851613:(a,b,c,d,f)=>{B.jb("ReduceMax",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},851771:(a,b,c,d,f)=>{B.jb("ReduceMin",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},851929:(a,b,c,d,f)=>{B.jb("ReduceProd",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852088:(a,b,c,d,f)=>{B.jb("ReduceSum",a,{keepDims:!!b,
noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852246:(a,b,c,d,f)=>{B.jb("ReduceL1",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852403:(a,b,c,d,f)=>{B.jb("ReduceL2",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852560:(a,b,c,d,f)=>{B.jb("ReduceLogSum",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852721:(a,b,c,d,f)=>{B.jb("ReduceSumSquare",a,
{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},852885:(a,b,c,d,f)=>{B.jb("ReduceLogSumExp",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},853049:a=>{B.jb("Where",a,void 0)},853102:(a,b,c)=>{B.jb("Transpose",a,{perm:b?Array.from(z().subarray(b>>>0,c>>>0)):[]})},853210:(a,b,c,d)=>{B.jb("DepthToSpace",a,{blocksize:b,mode:K(c),format:d?"NHWC":"NCHW"})},853343:(a,b,c,d)=>{B.jb("DepthToSpace",a,{blocksize:b,mode:K(c),format:d?
"NHWC":"NCHW"})},853476:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t)=>{B.jb("ConvTranspose",a,{format:p?"NHWC":"NCHW",autoPad:b,dilations:[c],group:d,kernelShape:[f],pads:[g,k],strides:[l],wIsConst:()=>!!e()[n>>>0],outputPadding:r?Array.from(z().subarray(r>>>0,x>>>0)):[],outputShape:y?Array.from(z().subarray(y>>>0,h>>>0)):[],activation:K(t)})},853877:(a,b,c,d,f,g,k,l,p,n,r,x,y,h)=>{B.jb("ConvTranspose",a,{format:l?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,(c>>>0)+2>>>0)),group:d,kernelShape:Array.from(z().subarray(f>>>
0,(f>>>0)+2>>>0)),pads:Array.from(z().subarray(g>>>0,(g>>>0)+4>>>0)),strides:Array.from(z().subarray(k>>>0,(k>>>0)+2>>>0)),wIsConst:()=>!!e()[p>>>0],outputPadding:n?Array.from(z().subarray(n>>>0,r>>>0)):[],outputShape:x?Array.from(z().subarray(x>>>0,y>>>0)):[],activation:K(h)})},854442:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t)=>{B.jb("ConvTranspose",a,{format:p?"NHWC":"NCHW",autoPad:b,dilations:[c],group:d,kernelShape:[f],pads:[g,k],strides:[l],wIsConst:()=>!!e()[n>>>0],outputPadding:r?Array.from(z().subarray(r>>>
0,x>>>0)):[],outputShape:y?Array.from(z().subarray(y>>>0,h>>>0)):[],activation:K(t)})},854843:(a,b,c,d,f,g,k,l,p,n,r,x,y,h)=>{B.jb("ConvTranspose",a,{format:l?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,(c>>>0)+2>>>0)),group:d,kernelShape:Array.from(z().subarray(f>>>0,(f>>>0)+2>>>0)),pads:Array.from(z().subarray(g>>>0,(g>>>0)+4>>>0)),strides:Array.from(z().subarray(k>>>0,(k>>>0)+2>>>0)),wIsConst:()=>!!e()[p>>>0],outputPadding:n?Array.from(z().subarray(n>>>0,r>>>0)):[],outputShape:x?
Array.from(z().subarray(x>>>0,y>>>0)):[],activation:K(h)})},855408:(a,b)=>{B.jb("GlobalAveragePool",a,{format:b?"NHWC":"NCHW"})},855499:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t,v)=>{B.jb("AveragePool",a,{format:v?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:d,storage_order:f,dilations:[g,k],kernel_shape:[l,p],pads:[n,r,x,y],strides:[h,t]})},855783:(a,b)=>{B.jb("GlobalAveragePool",a,{format:b?"NHWC":"NCHW"})},855874:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t,v)=>{B.jb("AveragePool",a,{format:v?"NHWC":"NCHW",auto_pad:b,
ceil_mode:c,count_include_pad:d,storage_order:f,dilations:[g,k],kernel_shape:[l,p],pads:[n,r,x,y],strides:[h,t]})},856158:(a,b)=>{B.jb("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},856245:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t,v)=>{B.jb("MaxPool",a,{format:v?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:d,storage_order:f,dilations:[g,k],kernel_shape:[l,p],pads:[n,r,x,y],strides:[h,t]})},856525:(a,b)=>{B.jb("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},856612:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t,v)=>{B.jb("MaxPool",
a,{format:v?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:d,storage_order:f,dilations:[g,k],kernel_shape:[l,p],pads:[n,r,x,y],strides:[h,t]})},856892:(a,b,c,d,f)=>{B.jb("Gemm",a,{alpha:b,beta:c,transA:d,transB:f})},856996:a=>{B.jb("MatMul",a,void 0)},857050:(a,b,c,d)=>{B.jb("ArgMax",a,{keepDims:!!b,selectLastIndex:!!c,axis:d})},857158:(a,b,c,d)=>{B.jb("ArgMin",a,{keepDims:!!b,selectLastIndex:!!c,axis:d})},857266:(a,b)=>{B.jb("Softmax",a,{axis:b})},857329:(a,b)=>{B.jb("Concat",a,{axis:b})},
857389:(a,b,c,d,f)=>{B.jb("Split",a,{axis:b,numOutputs:c,splitSizes:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},857529:a=>{B.jb("Expand",a,void 0)},857583:(a,b)=>{B.jb("Gather",a,{axis:Number(b)})},857654:(a,b)=>{B.jb("GatherElements",a,{axis:Number(b)})},857733:(a,b,c,d,f,g,k,l,p,n,r)=>{B.jb("Resize",a,{antialias:b,axes:c?Array.from(z().subarray(c>>>0,d>>>0)):[],coordinateTransformMode:K(f),cubicCoeffA:g,excludeOutside:k,extrapolationValue:l,keepAspectRatioPolicy:K(p),mode:K(n),nearestMode:K(r)})},
858079:(a,b,c,d,f,g,k)=>{B.jb("Slice",a,{starts:b?Array.from(z().subarray(b>>>0,c>>>0)):[],ends:d?Array.from(z().subarray(d>>>0,f>>>0)):[],axes:g?Array.from(z().subarray(g>>>0,k>>>0)):[]})},858295:a=>{B.jb("Tile",a,void 0)},858347:(a,b,c)=>{B.jb("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},858461:(a,b,c)=>{B.jb("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},858575:a=>{B.jb("Range",a,void 0)},858628:(a,b)=>{B.jb("Einsum",a,{equation:K(b)})},858709:(a,b,c,d,f)=>{B.jb("Pad",
a,{mode:b,value:c,pads:d?Array.from(z().subarray(d>>>0,f>>>0)):[]})},858836:(a,b,c,d,f,g)=>{B.jb("BatchNormalization",a,{epsilon:b,momentum:c,spatial:!!f,trainingMode:!!d,format:g?"NHWC":"NCHW"})},859005:(a,b,c,d,f,g)=>{B.jb("BatchNormalization",a,{epsilon:b,momentum:c,spatial:!!f,trainingMode:!!d,format:g?"NHWC":"NCHW"})},859174:(a,b,c)=>{B.jb("CumSum",a,{exclusive:Number(b),reverse:Number(c)})},859271:(a,b,c,d,f,g,k,l,p)=>{B.jb("Attention",a,{numHeads:b,isUnidirectional:c,maskFilterValue:d,scale:f,
doRotary:g,qkvHiddenSizes:k?Array.from(z().subarray(Number(l)>>>0,Number(l)+k>>>0)):[],pastPresentShareBuffer:!!p})},859543:a=>{B.jb("BiasAdd",a,void 0)},859598:a=>{B.jb("BiasSplitGelu",a,void 0)},859659:a=>{B.jb("FastGelu",a,void 0)},859715:(a,b,c,d,f,g,k,l,p,n,r,x,y,h,t,v)=>{B.jb("Conv",a,{format:x?"NHWC":"NCHW",auto_pad:b,dilations:c?Array.from(z().subarray(c>>>0,d>>>0)):[],group:f,kernel_shape:g?Array.from(z().subarray(g>>>0,k>>>0)):[],pads:l?Array.from(z().subarray(l>>>0,p>>>0)):[],strides:n?
Array.from(z().subarray(n>>>0,r>>>0)):[],w_is_const:()=>!!e()[y>>>0],activation:K(h),activation_params:t?Array.from(ja().subarray(t>>>0,v>>>0)):[]})},860211:a=>{B.jb("Gelu",a,void 0)},860263:(a,b,c,d)=>{B.jb("GroupQueryAttention",a,{numHeads:b,kvNumHeads:c,scale:d})},860376:(a,b,c,d)=>{B.jb("LayerNormalization",a,{axis:b,epsilon:c,simplified:!!d})},860487:(a,b,c,d)=>{B.jb("LayerNormalization",a,{axis:b,epsilon:c,simplified:!!d})},860598:(a,b,c,d,f,g)=>{B.jb("MatMulNBits",a,{k:b,n:c,accuracyLevel:d,
bits:f,blockSize:g})},860725:(a,b,c,d,f,g)=>{B.jb("MultiHeadAttention",a,{numHeads:b,isUnidirectional:c,maskFilterValue:d,scale:f,doRotary:g})},860884:(a,b)=>{B.jb("QuickGelu",a,{alpha:b})},860948:(a,b,c,d,f)=>{B.jb("RotaryEmbedding",a,{interleaved:!!b,numHeads:c,rotaryEmbeddingDim:d,scale:f})},861087:(a,b,c)=>{B.jb("SkipLayerNormalization",a,{epsilon:b,simplified:!!c})},861189:a=>{B.Yb(a)},861223:(a,b)=>B.$b(a,b,B.Eb.bc,B.Eb.errors),861335:(a,b,c)=>{B.jb("SkipLayerNormalization",a,{epsilon:b,simplified:!!c})}};
function mb(a,b,c){return Mc(async()=>{await B.Wb(a,b,c)})}function lb(){return"undefined"!==typeof wasmOffsetConverter}function Nc(a){this.name="ExitStatus";this.message=`Program terminated with exit(${a})`;this.status=a}
var Oc=a=>{a.terminate();a.onmessage=()=>{}},Rc=a=>{0==L.length&&(Pc(),Qc(L[0]));var b=L.pop();if(!b)return 6;M.push(b);N[a.Ab]=b;b.Ab=a.Ab;var c={cmd:"run",start_routine:a.cc,arg:a.Pb,pthread_ptr:a.Ab};D&&b.unref();b.postMessage(c,a.ic);return 0},O=0,P=(a,b,...c)=>{for(var d=2*c.length,f=Sc(),g=Tc(8*d),k=g>>>3,l=0;l<c.length;l++){var p=c[l];"bigint"==typeof p?(J[k+2*l]=1n,J[k+2*l+1]=p):(J[k+2*l]=0n,la()[k+2*l+1>>>0]=p)}a=Vc(a,0,d,g,b);Wc(f);return a};
...
c.push(f);a.postMessage({cmd:"load",handlers:c,wasmMemory:m,wasmModule:Ua})});function $c(a){E?a():Promise.all(L.map(Qc)).then(a)}function Pc(){var a=new Worker(new URL(import.meta.url),{type:"module",workerData:"em-pthread",name:"em-pthread"});L.push(a)}var cd=a=>{for(;0<a.length;)a.shift()(B)},Ma=()=>{var a=Ia(),b=A()[a+52>>>2>>>0];a=A()[a+56>>>2>>>0];dd(b,b-a);Wc(b)},Pa=(a,b)=>{O=0;a=ed(a,b);0<O?Va=a:Qa(a)};class fd{constructor(a){this.Ib=a-24}}var gd=0,hd=0;
...
function ob(a,b,c,d){a>>>=0;b>>>=0;c>>>=0;d>>>=0;if("undefined"==typeof SharedArrayBuffer)return H("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var f=[];if(E&&0===f.length)return jd(a,b,c,d);a={cc:c,Ab:a,Pb:d,ic:f};return E?(a.Lb="spawnThread",postMessage(a,f),0):Rc(a)}
...
function Hb(a,b,c,d,f){a>>>=0;c>>>=0;b=Q(b>>>0);-1===f&&(f=4294967295);f=l=>l;if(0===d){var g=32-8*c;f=l=>l<<g>>>g}var k=b.includes("unsigned")?function(l,p){return p>>>0}:function(l,p){return p};S(a,{name:b,fromWireType:f,toWireType:k,argPackAdvance:T,readValueFromPointer:ud(b,c,0!==d),Db:null})}
...
function Jb(a,b){a>>>=0;b=Q(b>>>0);var c="std::string"===b;S(a,{name:b,fromWireType:function(d){var f=A()[d>>>2>>>0],g=d+4;if(c)for(var k=g,l=0;l<=f;++l){var p=g+l;if(l==f||0==w()[p>>>0]){k=K(k,p-k);if(void 0===n)var n=k;else n+=String.fromCharCode(0),n+=k;k=p+1}}else{n=Array(f);for(l=0;l<f;++l)n[l]=String.fromCharCode(w()[g+l>>>0]);n=n.join("")}X(d);return n},toWireType:function(d,f){f instanceof ArrayBuffer&&(f=new Uint8Array(f));var g="string"==typeof f;if(!(g||f instanceof Uint8Array||f instanceof
Uint8ClampedArray||f instanceof Int8Array))throw new R("Cannot pass non-string to std::string");var k=c&&g?md(f):f.length;var l=zd(4+k+1),p=l+4;A()[l>>>2>>>0]=k;if(c&&g)od(f,p,k+1);else if(g)for(g=0;g<k;++g){var n=f.charCodeAt(g);if(255<n)throw X(p),new R("String has UTF-16 code units that do not fit in 8 bits");w()[p+g>>>0]=n}else for(g=0;g<k;++g)w()[p+g>>>0]=f[g];null!==d&&d.push(X,l);return l},argPackAdvance:T,readValueFromPointer:wd,Db(d){X(d)}})}
...
function Kb(a,b,c){a>>>=0;b>>>=0;c>>>=0;c=Q(c);if(2===b){var d=Bd;var f=Cd;var g=Dd;var k=l=>ea()[l>>>1>>>0]}else 4===b&&(d=Ed,f=Fd,g=Gd,k=l=>A()[l>>>2>>>0]);S(a,{name:c,fromWireType:l=>{for(var p=A()[l>>>2>>>0],n,r=l+4,x=0;x<=p;++x){var y=l+4+x*b;if(x==p||0==k(y))r=d(r,y-r),void 0===n?n=r:(n+=String.fromCharCode(0),n+=r),r=y+b}X(l);return n},toWireType:(l,p)=>{if("string"!=typeof p)throw new R(`Cannot pass non-string to C++ string type ${c}`);var n=g(p),r=zd(4+n+b);A()[r>>>2>>>0]=n/b;f(p,r+4,n+b);
null!==l&&l.push(X,r);return r},argPackAdvance:T,readValueFromPointer:wd,Db(l){X(l)}})}function Lb(a,b){a>>>=0;b=Q(b>>>0);S(a,{Sb:!0,name:b,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})}var Mb=()=>1;function Nb(a){Ka(a>>>0,!C,1,!qa,131072,!1);Na()}var Hd=a=>{if(!I)try{if(a(),!(0<O))try{E?Qa(Va):Dc(Va)}catch(b){b instanceof Nc||"unwind"==b||wa(1,b)}}catch(b){b instanceof Nc||"unwind"==b||wa(1,b)}};
function La(a){a>>>=0;"function"===typeof Atomics.jc&&(Atomics.jc(z(),a>>>2,a).value.then(Ra),a+=128,Atomics.store(z(),a>>>2,1))}var Ra=()=>{var a=Ia();a&&(La(a),Hd(Id))};function Ob(a,b){a>>>=0;a==b>>>0?setTimeout(Ra):E?postMessage({targetThread:a,cmd:"checkMailbox"}):(a=N[a])&&a.postMessage({cmd:"checkMailbox"})}var Jd=[];function Pb(a,b,c,d,f){b>>>=0;d/=2;Jd.length=d;c=f>>>0>>>3;for(f=0;f<d;f++)Jd[f]=J[c+2*f]?J[c+2*f+1]:la()[c+2*f+1>>>0];return(b?Lc[b]:Kd[a])(...Jd)}
...
function Pd(){var a=Y,b={};for(let [c,d]of Object.entries(a))b[c]="function"==typeof d?(...f)=>{Qd.push(c);try{return d(...f)}finally{I||(Qd.pop(),F&&1===Z&&0===Qd.length&&(Z=0,O+=1,Od(Rd),"undefined"!=typeof Fibers&&Fibers.oc()))}}:d;return b}var Z=0,F=null,Sd=0,Qd=[],Td={},Ud={},Vd=0,Wd=null,Xd=[];function sa(){return new Promise((a,b)=>{Wd={resolve:a,reject:b}})}
...
function Yb(a,b,c){b=ie(a,b>>>0);var d=b.shift();a--;var f="return function (obj, func, destructorsRef, args) {\n",g=0,k=[];0===c&&k.push("obj");for(var l=["retType"],p=[d],n=0;n<a;++n)k.push("arg"+n),l.push("argType"+n),p.push(b[n]),f+=`  var arg${n} = argType${n}.readValueFromPointer(args${g?"+"+g:""});\n`,g+=b[n].argPackAdvance;f+=`  var rv = ${1===c?"new func":"func.call"}(${k.join(", ")});\n`;d.Sb||(l.push("emval_returnValue"),p.push(Nd),f+="  return emval_returnValue(retType, destructorsRef, rv);\n");
l.push(f+"};\n");a=ke(l)(...p);c=`methodCaller<(${b.map(r=>r.name).join(", ")}) => ${d.name}>`;return he(je(c,a))}function Zb(a){a=fe(a>>>0);return W(B[a])}function $b(a,b){b>>>=0;a=V(a>>>0);b=V(b);return W(a[b])}function ac(a){a>>>=0;9<a&&(U[a+1]+=1)}function bc(){return W([])}function cc(a){a=V(a>>>0);for(var b=Array(a.length),c=0;c<a.length;c++)b[c]=a[c];return W(b)}function dc(a){return W(fe(a>>>0))}function ec(){return W({})}
...
function zc(){var a=Error().stack.toString().split("\n");"Error"==a[0]&&a.shift();se(a);re.Ob=qe();re.ac=a;return re.Ob}function Ac(a,b,c){a>>>=0;b>>>=0;if(re.Ob==a)var d=re.ac;else d=Error().stack.toString().split("\n"),"Error"==d[0]&&d.shift(),se(d);for(var f=3;d[f]&&qe()!=a;)++f;for(a=0;a<c&&d[a+f];++a)z()[b+4*a>>>2>>>0]=qe();return a}
...
var we=[null,[],[]];function Hc(a,b,c,d){if(E)return P(23,1,a,b,c,d);b>>>=0;c>>>=0;d>>>=0;for(var f=0,g=0;g<c;g++){var k=A()[b>>>2>>>0],l=A()[b+4>>>2>>>0];b+=8;for(var p=0;p<l;p++){var n=w()[k+p>>>0],r=we[a];0===n||10===n?((1===a?Ea:H)(ld(r,0)),r.length=0):r.push(n)}f+=l}A()[d>>>2>>>0]=f;return 0}var xe=[31,29,31,30,31,30,31,31,30,31,30,31],ye=[31,28,31,30,31,30,31,31,30,31,30,31];function ze(a){var b=Array(md(a)+1);nd(a,b,0,b.length);return b}var Ae=(a,b)=>{e().set(a,b>>>0)};
function Jc(a,b,c,d){function f(h,t,v){for(h="number"==typeof h?h.toString():h||"";h.length<t;)h=v[0]+h;return h}function g(h,t){return f(h,t,"0")}function k(h,t){function v(Uc){return 0>Uc?-1:0<Uc?1:0}var aa;0===(aa=v(h.getFullYear()-t.getFullYear()))&&0===(aa=v(h.getMonth()-t.getMonth()))&&(aa=v(h.getDate()-t.getDate()));return aa}function l(h){switch(h.getDay()){case 0:return new Date(h.getFullYear()-1,11,29);case 1:return h;case 2:return new Date(h.getFullYear(),0,3);case 3:return new Date(h.getFullYear(),
0,2);case 4:return new Date(h.getFullYear(),0,1);case 5:return new Date(h.getFullYear()-1,11,31);case 6:return new Date(h.getFullYear()-1,11,30)}}function p(h){var t=h.Bb;for(h=new Date((new Date(h.Cb+1900,0,1)).getTime());0<t;){var v=h.getMonth(),aa=(le(h.getFullYear())?xe:ye)[v];if(t>aa-h.getDate())t-=aa-h.getDate()+1,h.setDate(1),11>v?h.setMonth(v+1):(h.setMonth(0),h.setFullYear(h.getFullYear()+1));else{h.setDate(h.getDate()+t);break}}v=new Date(h.getFullYear()+1,0,4);t=l(new Date(h.getFullYear(),
0,4));v=l(v);return 0>=k(t,h)?0>=k(v,h)?h.getFullYear()+1:h.getFullYear():h.getFullYear()-1}a>>>=0;b>>>=0;c>>>=0;d>>>=0;var n=A()[d+40>>>2>>>0];d={fc:z()[d>>>2>>>0],ec:z()[d+4>>>2>>>0],Gb:z()[d+8>>>2>>>0],Kb:z()[d+12>>>2>>>0],Hb:z()[d+16>>>2>>>0],Cb:z()[d+20>>>2>>>0],ub:z()[d+24>>>2>>>0],Bb:z()[d+28>>>2>>>0],nc:z()[d+32>>>2>>>0],dc:z()[d+36>>>2>>>0],hc:n?K(n):""};c=K(c);n={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y",
...
x[h.ub],"%b":h=>y[h.Hb].substring(0,3),"%B":h=>y[h.Hb],"%C":h=>g((h.Cb+1900)/100|0,2),"%d":h=>g(h.Kb,2),"%e":h=>f(h.Kb,2," "),"%g":h=>p(h).toString().substring(2),"%G":p,"%H":h=>g(h.Gb,2),"%I":h=>{h=h.Gb;0==h?h=12:12<h&&(h-=12);return g(h,2)},"%j":h=>{for(var t=0,v=0;v<=h.Hb-1;t+=(le(h.Cb+1900)?xe:ye)[v++]);return g(h.Kb+t,3)},"%m":h=>g(h.Hb+1,2),"%M":h=>g(h.ec,2),"%n":()=>"\n","%p":h=>0<=h.Gb&&12>h.Gb?"AM":"PM","%S":h=>g(h.fc,2),"%t":()=>"\t","%u":h=>h.ub||7,"%U":h=>g(Math.floor((h.Bb+7-h.ub)/7),
2),"%V":h=>{var t=Math.floor((h.Bb+7-(h.ub+6)%7)/7);2>=(h.ub+371-h.Bb-2)%7&&t++;if(t)53==t&&(v=(h.ub+371-h.Bb)%7,4==v||3==v&&le(h.Cb)||(t=1));else{t=52;var v=(h.ub+7-h.Bb-1)%7;(4==v||5==v&&le(h.Cb%400-1))&&t++}return g(t,2)},"%w":h=>h.ub,"%W":h=>g(Math.floor((h.Bb+7-(h.ub+6)%7)/7),2),"%y":h=>(h.Cb+1900).toString().substring(2),"%Y":h=>h.Cb+1900,"%z":h=>{h=h.dc;var t=0<=h;h=Math.abs(h)/60;return(t?"+":"-")+String("0000"+(h/60*100+h%60)).slice(-4)},"%Z":h=>h.hc,"%%":()=>"%"};c=c.replace(/%%/g,"\x00\x00");
