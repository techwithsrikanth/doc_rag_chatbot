...
`}var sf,uf,ji,Xi=x(()=>{"use strict";z();q();N();Qt();sf=a=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${a}`}),uf=(a,e,o,t)=>{let n=e.dims,r=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:e,type:0}}var yt,Lf,ua,la,fa,ca,pa,da,ha,ma,ba,ya,ga,xa,Ta=x(()=>{"use strict";z();Bt();q();N();yt=(a,e,o,t=e[0].type,n)=>{let r=a.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],cacheHint:n,get:()=>Lf(a,e,o,t)}},Lf=(a,e,o,t=e[0].type)=>{let n=a.session.pack?2:0,r=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,i=a.session.pack;if(r){let f=it.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let p=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,b=e[1].dims.length!==0?e[1].dims.length:1,g=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",y=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",v=D(a.session.backend.glContext.version),_=i?`
      ${o.body}
      void main() {
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],output:{dims:e[0].dims,type:t,textureType:n},shaderSource:l,hasMain:!0}},ua=(a,e)=>[a.run(yt(a,e,gf()),e)],la=(a,e)=>[a.run(yt(a,e,Sf(),"bool"),e)],fa=(a,e)=>[a.run(yt(a,e,xf()),e)],ca=(a,e)=>[a.run(yt(a,e,wf(),"bool"),e)],pa=(a,e)=>[a.run(yt(a,e,If(),"bool"),e)],da=(a,e)=>[a.run(yt(a,e,_f(),"bool"),e)],ha=(a,e)=>[a.run(yt(a,e,Tf()),e)],ma=(a,e)=>[a.run(yt(a,e,Of(),"bool"),e)],ba=(a,e)=>[a.run(yt(a,e,Pf()),e)],ya=(a,e)=>[a.run(yt(a,e,Ef()),e)],ga=(a,e)=>[a.run(yt(a,e,vf()),e)],xa=(a,e)=>[a.run(yt(a,e,Af(),"bool"),e)]});var va,wa,kf,Ia=x(()=>{"use strict";z();va=(a,e,o)=>(kf(e),[a.cast(e[0],o)]),wa=a=>et.tensorDataTypeFromProto(a.attributes.getInt("to")),kf=a=>{if(!a||a.length!==1)throw new Error("Cast requires 1 input.");if(a[0].type==="string")throw new Error("Invalid input type.")}});var Bf,Ff,_a,ur,Sa=x(()=>{"use strict";q();N();Pt();Qt();Bf=(a,e)=>({name:"Concat (packed)",inputNames:Array.from({length:a},(o,t)=>`X${t}`),inputTypes:Array(a).fill(2),cacheHint:e}),Ff=(a,e,o,t)=>{let n=o[0].dims.slice();if(t>=n.length||t<-1*n.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=n.length+t);let r=n.slice(0);for(let F=1;F<o.length;F++){let st=o[F].dims.slice();for(let Ot=0;Ot<n.length;Ot++)if(Ot===t)r[t]+=st[Ot];else if(n[Ot]!==st[Ot])throw new Error("non concat dimensions must match")}let s=r.length,i=ce("coords",s),u=at(s),l=Et(),f=o.map(F=>F.dims),p=St(s),d=new Array(f.length-1);d[0]=f[0][t];for(let F=1;F<d.length;F++)d[F]=d[F-1]+f[F][t];let b=p[t],g=p.slice(-2),y=p.join(),v=`if (${b} < ${d[0]}) {
        ...
        }`;return{...e,output:{dims:r,type:o[0].type,textureType:0},shaderSource:d}},Gf=(a,e,o)=>{let t=Nf(e.length,o.cacheKey);return{...t,get:()=>Cf(a,t,e,o.axis)}},Aa=a=>`int getTextureWhereDataResides(int index) {
      ${a.map((o,t)=>`if(index<${o}) {return ${t};}
`).join("")}
    }`,Rf=a=>Aa(a),Vf=(a,e)=>{let o=[`float fetchDataFromCorrectTexture(int textureIndex, int indices[${e}]) {`];for(let t=0;t<a;++t)t===0?o.push(`	if (textureIndex == ${t}) { return _X${t}(indices); }`):t===a-1?o.push(`	else { return _X${t}(indices); }`):o.push(`	else if (textureIndex == ${t}) { return _X${t}(indices); }`);return o.push("	}"),o.join(`
...
`;return{...o,output:{dims:l,type:e[0].type,textureType:0},shaderSource:b,hasMain:!0}},Qa=(a,e,o)=>{let t=fc(e.length>2,o.cacheKey);return{...t,get:()=>cc(a,e,t,o)}}});var pc,dc,es,rs=x(()=>{"use strict";q();N();Qt();pc=a=>({name:"Im2Col (packed)",inputNames:["A"],inputTypes:[2],cacheHint:a}),dc=(a,e,o,t,n,r)=>{let s=o.dims,i=t.dims,u=2,l=3,f=n.length,p=[i[1]*i[2]*i[3],n[2]*n[3]],d=i[2]*i[3],b=Et(),g=D(a.session.backend.glContext.version),y="";for(let _=0;_<=1;_++)for(let O=0;O<=1;O++)y+=`
            blockIndex = rc.x + ${O};
            pos = rc.y + ${_};
...
`;return{...o,output:{dims:f,type:e[0].type,textureType:0},shaderSource:g,hasMain:!0}},Cc=(a,e,o)=>{let t=Fc(e.length>2,o.cacheKey);return{...t,get:()=>Nc(a,e,t,o)}},Gc=(a,e,o)=>a.run(Cc(a,e,o),e),Rc=(a,e)=>{let o=a.kernelShape.slice();if(a.kernelShape.length===0)for(let i=2;i<e[1].dims.length;++i)o.push(e[1].dims[i]);let t=a.pads.slice(),n=a.outputShape.slice(),r=e[0].dims;kc(r,o,a.dilations,a.autoPad,t,a.strides,a.outputPadding,n);let s=Object.assign({},a);return Object.assign(s,{kernelShape:o,pads:t,outputShape:n,cacheKey:a.cacheKey}),s},cs=a=>{let e=a.attributes,o=pe(e),t=e.getString("auto_pad","NOTSET"),n=e.getInts("dilations",[1,1]),r=e.getInt("group",1),s=e.getInts("kernel_shape",[]),i=e.getInts("output_padding",[0,0]),u=e.getInts("output_shape",[]),l=e.getInts("pads",[0,0,0,0]),f=e.getInts("strides",[1,1]);return $({autoPad:t,dilations:n,group:r,kernelShape:s,outputPadding:i,outputShape:u,pads:l,strides:f,...o})},Vc=(a,e)=>{if(!a||a.length!==2&&a.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(a[0].dims.length!==4||a[1].dims.length!==4)throw new Error("currently only support 2-dimensional conv");let o=a[0].dims[1],t=a[1].dims[0];if(o!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=a[1].dims[1]*e.group;if(a.length===3&&(a[2].dims.length!==1||a[2].dims[0]!==n))throw new Error("invalid bias");let r=a[0].dims.length-2;if(e.dilations.length!==r)throw new Error(`dilations should be ${r}D`);if(e.strides.length!==r)throw new Error(`strides should be ${r}D`);if(e.pads.length!==r*2)throw new Error(`pads should be ${r*2}D`);if(e.outputPadding.length!==r)throw new Error(`output_padding should be ${r}D`);if(e.kernelShape.length!==0&&e.kernelShape.length!==a[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==a[0].dims.length-2)throw new Error("invalid output shape");if(a[0].type!=="float32"||a[1].type!=="float32")throw new Error("ConvTranspose input(X,W) should be float tensor");if(a.length===3&&a[2].type!=="float32")throw new Error("ConvTranspose input(bias) should be float tensor")}});var ds,ee,hs,zc,ms,Mc,Uc,Wc,pr=x(()=>{"use strict";tt();z();N();ds={name:"Transpose",inputNames:["A"],inputTypes:[0]},ee=(a,e,o)=>(Wc(e),[a.run({...ds,cacheHint:o.cacheKey,get:()=>zc(a,e[0],o.perm)},e)]),hs=a=>$({perm:a.attributes.getInts("perm",[])}),zc=(a,e,o)=>{let t=e.dims;o=ms(t,o);let n=Mc(t,o),r=t.length,s=`
      ...
      float process(int indices[${r}]) {
        ...
        perm(a, indices);
        return _A(a);
      }`;return{...ds,output:{dims:n,type:e.type,textureType:0},shaderSource:s}},ms=(a,e)=>(e&&e.length!==a.length&&(e=[...a.keys()].reverse()),e),Mc=(a,e)=>(e=ms(a,e),A.sortBasedOnPerm(a,e)),Uc=(a,e,o)=>{let t=[];t.push(`void ${a}(out int a[${o}], int src[${o}]) {`);for(let n=0;n<o;++n)t.push(`	a[${e[n]}]=src[${n}];`);return t.push("	}"),t.join(`
`)},Wc=a=>{if(!a||a.length!==1)throw new Error("Transpose requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("input should be float tensor")}});var bs,ys,Hc,gs=x(()=>{"use strict";pr();bs=(a,e,o)=>{Hc(e);let t=o.blocksize,n=t*t,r=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[e[0].dims[0],t,t,e[0].dims[1]/n,e[0].dims[2],e[0].dims[3]]:[e[0].dims[0],e[0].dims[1]/n,t,t,e[0].dims[2],e[0].dims[3]],i=a.reshapeUnpacked(e[0],s),u={perm:r,cacheKey:`${r}`},[l]=ee(a,[i],u),f=[e[0].dims[0],e[0].dims[1]/n,e[0].dims[2]*t,e[0].dims[3]*t];return[a.reshapeUnpacked(l,f)]},ys=a=>{let e=a.attributes.getInt("blocksize");if(e<1)throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);let o=a.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:e}},Hc=a=>{if(a.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${a.length}`);if(a[0].type==="string"||a[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var xs,Ts,qc,vs=x(()=>{"use strict";z();xs=(a,e,o)=>{qc(e,o);let t=A.flattenShape(e[0].dims,o);return[a.reshapeUnpacked(e[0],t)]},Ts=a=>a.attributes.getInt("axis",1),qc=(a,e)=>{if(!a||a.length!==1)throw new Error("Flatten requires 1 input.");let o=a[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(e<-o||e>o)throw new Error("Invalid axis");if(a[0].type==="string")throw new Error("string tensor is not supported.")}});var Vt,Pe=x(()=>{"use strict";Vt=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var ws,Is,jc,Kc,Xc,Jc,_s=x(()=>{"use strict";tt();Pe();z();N();ws=(a,e,o)=>(Jc(e,o.axis),[a.run(Xc(a,e,o),e)]),Is=a=>$({axis:a.attributes.getInt("axis",0)}),jc={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Kc=(a,e,o,t)=>{let n=o[0].dims.slice(),r=o[1].dims.slice(),s=new Array(n.length+r.length-1);t=A.normalizeAxis(t,n.length);let i=[];for(let d=0;d<s.length;d++)d<t?(s[d]=n[d],i.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<t+r.length?(s[d]=r[d-t],i.push(`indexDataIdx[${d-t}] = outputIdx[${d}];`)):(s[d]=n[d-r.length+1],i.push(`inputIdx[${d-r.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=n.length,f=r.length||1,p=`
      float process(int outputIdx[${u}]) {
        ...
        return _A(inputIdx);
      }`;return{...e,output:{dims:s,type:o[0].type,textureType:0},shaderSource:p}},Xc=(a,e,o)=>{let t={...jc,cacheHint:o.cacheKey};return{...t,get:()=>Kc(a,t,e,o.axis)}},Jc=(a,e)=>{if(!a||a.length!==2)throw new Error("Gather requires 2 inputs.");let o=a[0].dims.length;if(o<1)throw new Error("Invalid input shape.");if(e<-o||e>o-1)throw new Error("Invalid axis.");if(Vt.indexOf(a[0].type)===-1)throw new Error("Invaid input type.");if(a[1].type!=="int32"&&a[1].type!=="int16")throw new Error("Invaid input type.")}});var Sn,Ss,Os,As,Zc,Yc,Qc,Ps=x(()=>{"use strict";tt();z();N();Sn=(a,e,o)=>(Qc(e,o),[a.run(Zc(e,o),e)]),Ss=(a,e)=>{let o=a.attributes.getInt("transA",0)!==0,t=a.attributes.getInt("transB",0)!==0,n=a.attributes.getFloat("alpha",1),r=a.attributes.getFloat("beta",1);return $({transA:o,transB:t,alpha:n,beta:r,isOptionalC:e})},Os=a=>Ss(a,!1),As=a=>Ss(a,!0),Zc=(a,e)=>{let o={name:"Gemm",inputNames:a.length===3?["A","B","C"]:["A","B"],inputTypes:a.length===3?[0,0,0]:[0,0],key:e.cacheKey};return{...o,get:()=>Yc(o,a,e)}},Yc=(a,e,o)=>{let t=e[0].dims.slice(),n=e[1].dims.slice(),[r,s]=er.getShapeOfGemmResult(t,o.transA,n,o.transB,e.length===3?e[2].dims:void 0),i=[r,s];if(!i)throw new Error("Can't use gemm on the given tensors");let u=t[t.length-1],l="";o.transA&&(u=t[0]),o.transA&&o.transB?l="value += _A_T(a) * _B_T(b);":o.transA&&!o.transB?l="value += _A_T(a) * _B(b);":!o.transA&&o.transB?l="value += _A(a) * _B_T(b);":!o.transA&&!o.transB&&(l="value += _A(a) * _B(b);");let f=i.length,p=e.length===3?`int c[${e[2].dims.length}];`:"",d=e.length===3?"bcastIndices_C(indices, c);":"",b=e.length===3?"value += beta * _C(c);":"",g=`
...
`)},op=a=>{if(!a||a.length!==1)throw new Error("ImageScaler requires 1 input.");if(a[0].dims.length!==4)throw new Error("Invalid input shape.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type.")}});var ks,Bs,$s,ip,ap,sp,up,lp,fp,Fs=x(()=>{"use strict";q();N();ks=(a,e,o)=>{fp(e);let t=a.run(ap(e[0]),e);return[a.run(lp(a,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},Bs=a=>a.attributes.getFloat("epsilon",1e-5),$s={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},ip=(a,e)=>{let o=e.dims.slice(),t=o[1],n=o[2]*o[3],r=[o[0],t],s=`
  ...
  void offsetToIndices(int offset, int[${a}] strides, out int[${a}] indices) {
    ...
    indices[${a} - 1] = offset;
  }`});var re,zt,Sp,Op,nu,ou,iu,au,su,uu,lu,fu=x(()=>{"use strict";tt();Pe();z();N();re=(a,e,o,t,n)=>{Op(e);let r={name:t,inputNames:["A"],inputTypes:[0]};return[a.run({...r,cacheHint:o.cacheKey,get:()=>Sp(a,e,o,t,n,r)},e)]},zt=a=>{let e=a.attributes.getInts("axes",[]),o=a.attributes.getInt("keepdims",1)===1;return $({axes:e,keepDims:o})},Sp=(a,e,o,t,n,r)=>{let s=[],i=e[0].dims.length||1,u=[],l=A.normalizeAxes(o.axes,e[0].dims.length),f=n(e,l),p=f[1];for(let g=0;g<e[0].dims.length;g++)l.indexOf(g)>=0||l.length===0?(o.keepDims&&s.push(1),p=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),su=(a,e,o)=>re(a,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),uu=(a,e,o)=>re(a,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),lu=(a,e,o)=>re(a,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var cu,pu=x(()=>{"use strict";z();cu=(a,e)=>{let o=A.calculateReshapedDims(e[0].dims,e[1].integerData);return a.session.pack?[a.reshapePacked(e[0],o)]:[a.reshapeUnpacked(e[0],o)]}});var du,An,hu,mu,Ee,Ap,Pn,mr,En=x(()=>{"use strict";tt();q();N();du={name:"Upsample",inputNames:["X"],inputTypes:[0]},An=(a,e,o)=>(Pn(e,o),[a.run({...du,cacheHint:o.cacheKey,get:()=>Ap(a,e,o)},e)]),hu=a=>Ee(a,7),mu=a=>Ee(a,9),Ee=(a,e)=>{let o=e>=10,t=a.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let n=[];e<9&&(n=a.attributes.getFloats("scales"),mr(n,t,o));let r=a.attributes.getFloat("extrapolation_value",0),s=e>10?a.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let i=s==="tf_crop_and_resize",u=i,l=t==="nearest"&&e>=11?a.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=a.attributes.getFloat("cubic_coeff_a",-.75),p=a.attributes.getInt("exclude_outside",0)!==0;if(p&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",b=0,g=0,y=0;return e>10?a.inputs.length>2?(b=1,g=2,y=3):(g=1,y=2):e===9&&(g=1),$({opset:e,isResize:o,mode:t,scales:n,extrapolationValue:r,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:i,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:b,scalesInputIdx:g,sizesInputIdx:y})},Ap=(a,e,o)=>{let t=D(a.session.backend.glContext.version),[n,r]=a.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((y,v)=>Math.floor(y*o.scales[v])),[i,u]=a.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),d=`
    ...
    }`;return{...Pu,output:{dims:e.dims,type:e.type,textureType:0},shaderSource:l}},Bu=a=>{if(!a||a.length!==1)throw new Error("Softmax requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type")}});var Nu,Cu,Gu,Rp,Vp,zp,Ru=x(()=>{"use strict";tt();z();N();Nu={name:"Split",inputNames:["A"],inputTypes:[0]},Cu=(a,e,o)=>{zp(e);let t=A.normalizeAxis(o.axis,e[0].dims.length),n=Rp(a,e,t,o),r=[];for(let s=0;s<n;++s)r.push(a.run({...Nu,cacheHint:`${o.cacheKey};${s}`,get:()=>Vp(a,e[0],o,t,s)},e));return r},Gu=a=>{let e=a.attributes.getInt("axis",0),o=a.attributes.getInts("split",[]),t=a.outputs.length;return $({axis:e,split:o,numOutputs:t})},Rp=(a,e,o,t)=>{let[,n]=we.splitShape(e[0].dims,o,t.split,t.numOutputs);return n.length},Vp=(a,e,o,t,n)=>{let[r,s]=we.splitShape(e.dims,t,o.split,o.numOutputs),i=s[n],u=r[n],f=`
      float process(int indices[${u.length}]) {
        indices[${t}] += ${i};
        return _A(indices);
      }
    `;return{...Nu,cacheHint:`${o.cacheKey}:${n}`,output:{dims:u,type:e.type,textureType:0},shaderSource:f}},zp=a=>{if(!a||a.length!==1)throw new Error("Split requires one input.");if(a[0].type!=="int8"&&a[0].type!=="uint8"&&a[0].type!=="int16"&&a[0].type!=="uint16"&&a[0].type!=="int32"&&a[0].type!=="uint32"&&a[0].type!=="float32"&&a[0].type!=="float64"&&a[0].type!=="bool")throw new Error("Invalid input type.")}});var kn,Vu,zu,Mp,Up,Mu=x(()=>{"use strict";z();kn=(a,e,o)=>{Mp(e);let t=A.squeezeShape(e[0].dims,o);return[a.reshapeUnpacked(e[0],t)]},Vu=(a,e)=>(Up(e),kn(a,[e[0]],Array.from(e[1].integerData))),zu=a=>a.attributes.getInts("axes"),Mp=a=>{if(!a||a.length!==1)throw new Error("Squeeze requires 1 input.");if(a[0].type==="string")throw new Error("invalid input tensor types.")},Up=a=>{if(!a||a.length!==2)throw new Error("Squeeze requires 2 inputs.");if(a[1].type!=="int32")throw new Error("Invalid input type.")}});var Uu,Wp,Hp,Wu=x(()=>{"use strict";q();N();Uu=(a,e)=>{Hp(e);let o={name:"Sum",inputNames:e.map((n,r)=>`X${r}`),inputTypes:new Array(e.length).fill(0)};return[a.run({...o,get:()=>Wp(a,e,o)},e)]},Wp=(a,e,o)=>{let t=D(a.session.backend.glContext.version),n=e[0].dims.slice(),s=`
      void main() {
...
`);let _="";p<2&&f>0?_="coords":_=s.map((Mt,$e)=>`coords.${v[$e+g]}`).join(", ");let O="return outputValue;",C=A.size(s)===1,st=A.size(i)===1;if(f===1&&!C&&!st)O=`
      ...
      `;else if(C&&!st)p===1?O=`
        ...
        `;else if(d.length){let Mt=f-2,$e=f-1;d.indexOf(Mt)>-1&&d.indexOf($e)>-1?O="return vec4(outputValue.x);":d.indexOf(Mt)>-1?O="return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);":d.indexOf($e)>-1&&(O="return vec4(outputValue.xx, outputValue.zz);")}let Ot=`
