...
`))}return O}finally{c.Eb=null}};c._OrtCreateSession=d(c._OrtCreateSession,()=>c._OrtCreateSession,y=>c._OrtCreateSession=y),c._OrtRun=m(d(c._OrtRun,()=>c._OrtRun,y=>c._OrtRun=y)),c._OrtRunWithBinding=m(d(c._OrtRunWithBinding,()=>c._OrtRunWithBinding,y=>c._OrtRunWithBinding=y)),c._OrtBindInput=d(c._OrtBindInput,()=>c._OrtBindInput,y=>c._OrtBindInput=y),w=void 0};c.jsepInit=(d,m)=>{if(w?.(),d==="webgpu"){[c.Mb,c.Tb,c.Xb,c.Nb,c.Wb,c.jb,c.Yb,c.$b,c.Ub,c.Vb,c.Zb]=m;let y=c.Mb;c.jsepRegisterBuffer=(x,_,O,R)=>y.registerBuffer(x,_,O,R),c.jsepGetBuffer=x=>y.getBuffer(x),c.jsepCreateDownloader=(x,_,O)=>y.createDownloader(x,_,O),c.jsepOnReleaseSession=x=>{y.onReleaseSession(x)},c.jsepOnRunStart=x=>y.onRunStart(x)}};var v,S,$=Object.assign({},c),P="./this.program",E=(d,m)=>{throw m},N="";(b||h)&&(h?N=self.location.href:typeof document<"u"&&document.currentScript&&(N=document.currentScript.src),Ls&&(N=Ls),N=N.startsWith("blob:")?"":N.substr(0,N.replace(/[?#].*/,"").lastIndexOf("/")+1),h&&(S=d=>{var m=new XMLHttpRequest;return m.open("GET",d,!1),m.responseType="arraybuffer",m.send(null),new Uint8Array(m.response)}),v=(d,m,y)=>{var x=new XMLHttpRequest;x.open("GET",d,!0),x.responseType="arraybuffer",x.onload=()=>{x.status==200||x.status==0&&x.response?m(x.response):y()},x.onerror=y,x.send(null)});var z,q=console.log.bind(console),j=console.error.bind(console),G=q,ae=j;if(Object.assign(c,$),$=null,g){let d=function(m){try{var y=m.data,x=y.cmd;if(x==="load"){let _=[];self.onmessage=O=>_.push(O),self.startWorker=()=>{postMessage({cmd:"loaded"});for(let O of _)d(O);self.onmessage=d};for(let O of y.handlers)c[O]&&!c[O].proxy||(c[O]=(...R)=>{postMessage({Lb:"callHandler",kc:O,args:R})},O=="print"&&(G=c[O]),O=="printErr"&&(ae=c[O]));Ie=y.wasmMemory,ze(),$e(y.wasmModule)}else if(x==="run"){va(y.pthread_ptr,0,0,1,0,0),pa(y.pthread_ptr),Fx(),Cu(),we||(Pl(),we=!0);try{Mx(y.start_routine,y.arg)}catch(_){if(_!="unwind")throw _}}else x==="cancel"?sn()&&go(-1):y.target!=="setimmediate"&&(x==="checkMailbox"?we&&ao():x&&(ae(`worker: received unknown command ${x}`),ae(y)))}catch(_){throw Ol(),_}};var qI=d,$e,we=!1;ae=function(...m){m=m.join(" "),console.error(m)},self.alert=function(...m){postMessage({Lb:"alert",text:m.join(" "),mc:sn()})},c.instantiateWasm=(m,y)=>new Promise(x=>{$e=_=>{_=new WebAssembly.Instance(_,$u()),y(_),x()}}),self.onunhandledrejection=m=>{throw m.reason||m},self.onmessage=d}c.wasmBinary&&(z=c.wasmBinary);var Ie,ie,Te,pe,xe,se,me,ce,st,M,Q,Se,bt,je=!1;function ze(){var d=Ie.buffer;c.HEAP8=pe=new Int8Array(d),c.HEAP16=se=new Int16Array(d),c.HEAPU8=xe=new Uint8Array(d),c.HEAPU16=me=new Uint16Array(d),c.HEAP32=ce=new Int32Array(d),c.HEAPU32=st=new Uint32Array(d),c.HEAPF32=M=new Float32Array(d),c.HEAPF64=bt=new Float64Array(d),c.HEAP64=Q=new BigInt64Array(d),c.HEAPU64=Se=new BigUint64Array(d)}if(!g){if(!((Ie=new WebAssembly.Memory({initial:256,maximum:65536,shared:!0})).buffer instanceof T))throw ae("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),Error("bad memory");ze()}var Pn=[],ut=[],pt=[],Ot=0,tn=null,Or=null;function wu(){if(--Ot==0&&(tn!==null&&(clearInterval(tn),tn=null),Or)){var d=Or;Or=null,d()}}function rn(d){throw ae(d="Aborted("+d+")"),je=!0,Te=1,d=new WebAssembly.RuntimeError(d+". Build with -sASSERTIONS for more info."),f(d),d}var ta,Tu=d=>d.startsWith("data:application/octet-stream;base64,"),_u=d=>d.startsWith("file://");function Iu(d){if(d==ta&&z)return new Uint8Array(z);if(S)return S(d);throw"both async and sync fetching of the wasm failed"}function Su(d,m,y){return function(x){if(!z&&(b||h)){if(typeof fetch=="function"&&!_u(x))return fetch(x,{credentials:"same-origin"}).then(_=>{if(!_.ok)throw`failed to load wasm binary file at '${x}'`;return _.arrayBuffer()}).catch(()=>Iu(x));if(v)return new Promise((_,O)=>{v(x,R=>_(new Uint8Array(R)),O)})}return Promise.resolve().then(()=>Iu(x))}(d).then(x=>WebAssembly.instantiate(x,m)).then(y,x=>{ae(`failed to asynchronously prepare wasm: ${x}`),rn(x)})}function $u(){return{a:{M:zx,za:Nx,b:Gx,$:Lu,z:zu,pa:Fu,X:Vu,Z:Gu,qa:Uu,na:Wu,ga:Hu,ma:qu,J:ju,Y:Ku,V:Xu,oa:Zu,W:Yu,va:Ux,D:Hx,P:qx,O:Kx,C:Zx,s:Yx,p:Jx,E:Qx,y:a0,Q:s0,ta:u0,ja:l0,T:c0,aa:f0,F:d0,ia:pa,sa:p0,u:m0,B:b0,o:y0,m:v0,c:fa,n:w0,k:I0,Aa:S0,r:$0,f:A0,v:P0,l:O0,g:E0,i:C0,j:k0,h:D0,e:B0,da:L0,ea:R0,fa:N0,ba:fl,ca:dl,S:z0,d:F0,N:M0,G:V0,K:G0,w:U0,ra:W0,U:H0,t:ml,x:q0,L:j0,R:K0,ya:X0,xa:Z0,ka:bl,la:yl,_:aa,A:xl,I:vl,ha:wl,H:Tl,a:Ie,wa:ia,ua:Sl,q:Q0}}}var ra={848436:(d,m,y,x)=>{if(c===void 0||!c.Fb)return 1;if((d=rt(d>>>0)).startsWith("./")&&(d=d.substring(2)),!(d=c.Fb.get(d)))return 2;if(x>>>=0,(m>>>=0)+(y>>>=0)>d.byteLength)return 3;try{return n().set(d.subarray(m,m+y),x>>>0),0}catch{return 4}},848937:()=>{c.Ub()},848968:()=>{c.Vb()},848997:()=>{c.Zb()},849022:d=>c.Tb(d),849055:d=>c.Xb(d),849087:(d,m,y)=>{c.Nb(d,m,y,!0)},849126:(d,m,y)=>{c.Nb(d,m,y)},849159:()=>typeof wasmOffsetConverter<"u",849216:d=>{c.jb("Abs",d,void 0)},849267:d=>{c.jb("Neg",d,void 0)},849318:d=>{c.jb("Floor",d,void 0)},849371:d=>{c.jb("Ceil",d,void 0)},849423:d=>{c.jb("Reciprocal",d,void 0)},849481:d=>{c.jb("Sqrt",d,void 0)},849533:d=>{c.jb("Exp",d,void 0)},849584:d=>{c.jb("Erf",d,void 0)},849635:d=>{c.jb("Sigmoid",d,void 0)},849690:(d,m,y)=>{c.jb("HardSigmoid",d,{alpha:m,beta:y})},849769:d=>{c.jb("Log",d,void 0)},849820:d=>{c.jb("Sin",d,void 0)},849871:d=>{c.jb("Cos",d,void 0)},849922:d=>{c.jb("Tan",d,void 0)},849973:d=>{c.jb("Asin",d,void 0)},850025:d=>{c.jb("Acos",d,void 0)},850077:d=>{c.jb("Atan",d,void 0)},850129:d=>{c.jb("Sinh",d,void 0)},850181:d=>{c.jb("Cosh",d,void 0)},850233:d=>{c.jb("Asinh",d,void 0)},850286:d=>{c.jb("Acosh",d,void 0)},850339:d=>{c.jb("Atanh",d,void 0)},850392:d=>{c.jb("Tanh",d,void 0)},850444:d=>{c.jb("Not",d,void 0)},850495:(d,m,y)=>{c.jb("Clip",d,{min:m,max:y})},850564:d=>{c.jb("Clip",d,void 0)},850616:(d,m)=>{c.jb("Elu",d,{alpha:m})},850674:d=>{c.jb("Relu",d,void 0)},850726:(d,m)=>{c.jb("LeakyRelu",d,{alpha:m})},850790:(d,m)=>{c.jb("ThresholdedRelu",d,{alpha:m})},850860:(d,m)=>{c.jb("Cast",d,{to:m})},850918:d=>{c.jb("Add",d,void 0)},850969:d=>{c.jb("Sub",d,void 0)},851020:d=>{c.jb("Mul",d,void 0)},851071:d=>{c.jb("Div",d,void 0)},851122:d=>{c.jb("Pow",d,void 0)},851173:d=>{c.jb("Equal",d,void 0)},851226:d=>{c.jb("Greater",d,void 0)},851281:d=>{c.jb("GreaterOrEqual",d,void 0)},851343:d=>{c.jb("Less",d,void 0)},851395:d=>{c.jb("LessOrEqual",d,void 0)},851454:(d,m,y,x,_)=>{c.jb("ReduceMean",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},851613:(d,m,y,x,_)=>{c.jb("ReduceMax",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},851771:(d,m,y,x,_)=>{c.jb("ReduceMin",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},851929:(d,m,y,x,_)=>{c.jb("ReduceProd",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852088:(d,m,y,x,_)=>{c.jb("ReduceSum",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852246:(d,m,y,x,_)=>{c.jb("ReduceL1",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852403:(d,m,y,x,_)=>{c.jb("ReduceL2",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852560:(d,m,y,x,_)=>{c.jb("ReduceLogSum",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852721:(d,m,y,x,_)=>{c.jb("ReduceSumSquare",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},852885:(d,m,y,x,_)=>{c.jb("ReduceLogSumExp",d,{keepDims:!!m,noopWithEmptyAxes:!!y,axes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},853049:d=>{c.jb("Where",d,void 0)},853102:(d,m,y)=>{c.jb("Transpose",d,{perm:m?Array.from(i().subarray(m>>>0,y>>>0)):[]})},853210:(d,m,y,x)=>{c.jb("DepthToSpace",d,{blocksize:m,mode:rt(y),format:x?"NHWC":"NCHW"})},853343:(d,m,y,x)=>{c.jb("DepthToSpace",d,{blocksize:m,mode:rt(y),format:x?"NHWC":"NCHW"})},853476:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe)=>{c.jb("ConvTranspose",d,{format:K?"NHWC":"NCHW",autoPad:m,dilations:[y],group:x,kernelShape:[_],pads:[O,R],strides:[F],wIsConst:()=>!!e()[Y>>>0],outputPadding:ne?Array.from(i().subarray(ne>>>0,Pe>>>0)):[],outputShape:ke?Array.from(i().subarray(ke>>>0,L>>>0)):[],activation:rt(fe)})},853877:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L)=>{c.jb("ConvTranspose",d,{format:F?"NHWC":"NCHW",autoPad:m,dilations:Array.from(i().subarray(y>>>0,2+(y>>>0)>>>0)),group:x,kernelShape:Array.from(i().subarray(_>>>0,2+(_>>>0)>>>0)),pads:Array.from(i().subarray(O>>>0,4+(O>>>0)>>>0)),strides:Array.from(i().subarray(R>>>0,2+(R>>>0)>>>0)),wIsConst:()=>!!e()[K>>>0],outputPadding:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],outputShape:Pe?Array.from(i().subarray(Pe>>>0,ke>>>0)):[],activation:rt(L)})},854442:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe)=>{c.jb("ConvTranspose",d,{format:K?"NHWC":"NCHW",autoPad:m,dilations:[y],group:x,kernelShape:[_],pads:[O,R],strides:[F],wIsConst:()=>!!e()[Y>>>0],outputPadding:ne?Array.from(i().subarray(ne>>>0,Pe>>>0)):[],outputShape:ke?Array.from(i().subarray(ke>>>0,L>>>0)):[],activation:rt(fe)})},854843:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L)=>{c.jb("ConvTranspose",d,{format:F?"NHWC":"NCHW",autoPad:m,dilations:Array.from(i().subarray(y>>>0,2+(y>>>0)>>>0)),group:x,kernelShape:Array.from(i().subarray(_>>>0,2+(_>>>0)>>>0)),pads:Array.from(i().subarray(O>>>0,4+(O>>>0)>>>0)),strides:Array.from(i().subarray(R>>>0,2+(R>>>0)>>>0)),wIsConst:()=>!!e()[K>>>0],outputPadding:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],outputShape:Pe?Array.from(i().subarray(Pe>>>0,ke>>>0)):[],activation:rt(L)})},855408:(d,m)=>{c.jb("GlobalAveragePool",d,{format:m?"NHWC":"NCHW"})},855499:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe,Re)=>{c.jb("AveragePool",d,{format:Re?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[F,K],pads:[Y,ne,Pe,ke],strides:[L,fe]})},855783:(d,m)=>{c.jb("GlobalAveragePool",d,{format:m?"NHWC":"NCHW"})},855874:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe,Re)=>{c.jb("AveragePool",d,{format:Re?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[F,K],pads:[Y,ne,Pe,ke],strides:[L,fe]})},856158:(d,m)=>{c.jb("GlobalMaxPool",d,{format:m?"NHWC":"NCHW"})},856245:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe,Re)=>{c.jb("MaxPool",d,{format:Re?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[F,K],pads:[Y,ne,Pe,ke],strides:[L,fe]})},856525:(d,m)=>{c.jb("GlobalMaxPool",d,{format:m?"NHWC":"NCHW"})},856612:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe,Re)=>{c.jb("MaxPool",d,{format:Re?"NHWC":"NCHW",auto_pad:m,ceil_mode:y,count_include_pad:x,storage_order:_,dilations:[O,R],kernel_shape:[F,K],pads:[Y,ne,Pe,ke],strides:[L,fe]})},856892:(d,m,y,x,_)=>{c.jb("Gemm",d,{alpha:m,beta:y,transA:x,transB:_})},856996:d=>{c.jb("MatMul",d,void 0)},857050:(d,m,y,x)=>{c.jb("ArgMax",d,{keepDims:!!m,selectLastIndex:!!y,axis:x})},857158:(d,m,y,x)=>{c.jb("ArgMin",d,{keepDims:!!m,selectLastIndex:!!y,axis:x})},857266:(d,m)=>{c.jb("Softmax",d,{axis:m})},857329:(d,m)=>{c.jb("Concat",d,{axis:m})},857389:(d,m,y,x,_)=>{c.jb("Split",d,{axis:m,numOutputs:y,splitSizes:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},857529:d=>{c.jb("Expand",d,void 0)},857583:(d,m)=>{c.jb("Gather",d,{axis:Number(m)})},857654:(d,m)=>{c.jb("GatherElements",d,{axis:Number(m)})},857733:(d,m,y,x,_,O,R,F,K,Y,ne)=>{c.jb("Resize",d,{antialias:m,axes:y?Array.from(i().subarray(y>>>0,x>>>0)):[],coordinateTransformMode:rt(_),cubicCoeffA:O,excludeOutside:R,extrapolationValue:F,keepAspectRatioPolicy:rt(K),mode:rt(Y),nearestMode:rt(ne)})},858079:(d,m,y,x,_,O,R)=>{c.jb("Slice",d,{starts:m?Array.from(i().subarray(m>>>0,y>>>0)):[],ends:x?Array.from(i().subarray(x>>>0,_>>>0)):[],axes:O?Array.from(i().subarray(O>>>0,R>>>0)):[]})},858295:d=>{c.jb("Tile",d,void 0)},858347:(d,m,y)=>{c.jb("InstanceNormalization",d,{epsilon:m,format:y?"NHWC":"NCHW"})},858461:(d,m,y)=>{c.jb("InstanceNormalization",d,{epsilon:m,format:y?"NHWC":"NCHW"})},858575:d=>{c.jb("Range",d,void 0)},858628:(d,m)=>{c.jb("Einsum",d,{equation:rt(m)})},858709:(d,m,y,x,_)=>{c.jb("Pad",d,{mode:m,value:y,pads:x?Array.from(i().subarray(x>>>0,_>>>0)):[]})},858836:(d,m,y,x,_,O)=>{c.jb("BatchNormalization",d,{epsilon:m,momentum:y,spatial:!!_,trainingMode:!!x,format:O?"NHWC":"NCHW"})},859005:(d,m,y,x,_,O)=>{c.jb("BatchNormalization",d,{epsilon:m,momentum:y,spatial:!!_,trainingMode:!!x,format:O?"NHWC":"NCHW"})},859174:(d,m,y)=>{c.jb("CumSum",d,{exclusive:Number(m),reverse:Number(y)})},859271:(d,m,y,x,_,O,R,F,K)=>{c.jb("Attention",d,{numHeads:m,isUnidirectional:y,maskFilterValue:x,scale:_,doRotary:O,qkvHiddenSizes:R?Array.from(i().subarray(Number(F)>>>0,Number(F)+R>>>0)):[],pastPresentShareBuffer:!!K})},859543:d=>{c.jb("BiasAdd",d,void 0)},859598:d=>{c.jb("BiasSplitGelu",d,void 0)},859659:d=>{c.jb("FastGelu",d,void 0)},859715:(d,m,y,x,_,O,R,F,K,Y,ne,Pe,ke,L,fe,Re)=>{c.jb("Conv",d,{format:Pe?"NHWC":"NCHW",auto_pad:m,dilations:y?Array.from(i().subarray(y>>>0,x>>>0)):[],group:_,kernel_shape:O?Array.from(i().subarray(O>>>0,R>>>0)):[],pads:F?Array.from(i().subarray(F>>>0,K>>>0)):[],strides:Y?Array.from(i().subarray(Y>>>0,ne>>>0)):[],w_is_const:()=>!!e()[ke>>>0],activation:rt(L),activation_params:fe?Array.from(a().subarray(fe>>>0,Re>>>0)):[]})},860211:d=>{c.jb("Gelu",d,void 0)},860263:(d,m,y,x)=>{c.jb("GroupQueryAttention",d,{numHeads:m,kvNumHeads:y,scale:x})},860376:(d,m,y,x)=>{c.jb("LayerNormalization",d,{axis:m,epsilon:y,simplified:!!x})},860487:(d,m,y,x)=>{c.jb("LayerNormalization",d,{axis:m,epsilon:y,simplified:!!x})},860598:(d,m,y,x,_,O)=>{c.jb("MatMulNBits",d,{k:m,n:y,accuracyLevel:x,bits:_,blockSize:O})},860725:(d,m,y,x,_,O)=>{c.jb("MultiHeadAttention",d,{numHeads:m,isUnidirectional:y,maskFilterValue:x,scale:_,doRotary:O})},860884:(d,m)=>{c.jb("QuickGelu",d,{alpha:m})},860948:(d,m,y,x,_)=>{c.jb("RotaryEmbedding",d,{interleaved:!!m,numHeads:y,rotaryEmbeddingDim:x,scale:_})},861087:(d,m,y)=>{c.jb("SkipLayerNormalization",d,{epsilon:m,simplified:!!y})},861189:d=>{c.Yb(d)},861223:(d,m)=>c.$b(d,m,c.Eb.bc,c.Eb.errors),861335:(d,m,y)=>{c.jb("SkipLayerNormalization",d,{epsilon:m,simplified:!!y})}};function Nx(d,m,y){return al(async()=>{await c.Wb(d,m,y)})}function zx(){return typeof wasmOffsetConverter<"u"}function na(d){this.name="ExitStatus",this.message=`Program terminated with exit(${d})`,this.status=d}var oa=d=>{d.terminate(),d.onmessage=()=>{}},Au=d=>{gr.length==0&&(Du(),ku(gr[0]));var m=gr.pop();if(!m)return 6;Cr.push(m),Kt[d.Ab]=m,m.Ab=d.Ab;var y={cmd:"run",start_routine:d.cc,arg:d.Pb,pthread_ptr:d.Ab};return m.postMessage(y,d.ic),0},Er=0,He=(d,m,...y)=>{for(var x=2*y.length,_=_a(),O=Ta(8*x),R=O>>>3,F=0;F<y.length;F++){var K=y[F];typeof K=="bigint"?(Q[R+2*F]=1n,Q[R+2*F+1]=K):(Q[R+2*F]=0n,u()[R+2*F+1>>>0]=K)}return d=El(d,0,x,O,m),bo(_),d};function ia(d){if(g)return He(0,1,d);if(Te=d,!(0<Er)){for(var m of Cr)oa(m);for(m of gr)oa(m);gr=[],Cr=[],Kt=[],je=!0}E(d,new na(d))}function Pu(d){if(g)return He(1,0,d);aa(d)}var aa=d=>{if(Te=d,g)throw Pu(d),"unwind";ia(d)},gr=[],Cr=[],Ou=[],Kt={},Eu=d=>{var m=d.Ab;delete Kt[m],gr.push(d),Cr.splice(Cr.indexOf(d),1),d.Ab=0,wa(m)};function Cu(){Ou.forEach(d=>d())}var ku=d=>new Promise(m=>{d.onmessage=_=>{var O=(_=_.data).cmd;if(_.targetThread&&_.targetThread!=sn()){var R=Kt[_.targetThread];R?R.postMessage(_,_.transferList):ae(`Internal error! Worker sent a message "${O}" to target pthread ${_.targetThread}, but that thread no longer exists!`)}else O==="checkMailbox"?ao():O==="spawnThread"?Au(_):O==="cleanupThread"?Eu(Kt[_.thread]):O==="killThread"?(_=_.thread,O=Kt[_],delete Kt[_],oa(O),wa(_),Cr.splice(Cr.indexOf(O),1),O.Ab=0):O==="cancelThread"?Kt[_.thread].postMessage({cmd:"cancel"}):O==="loaded"?(d.loaded=!0,m(d)):O==="alert"?alert(`Thread ${_.threadId}: ${_.text}`):_.target==="setimmediate"?d.postMessage(_):O==="callHandler"?c[_.handler](..._.args):O&&ae(`worker sent an unknown command ${O}`)},d.onerror=_=>{throw ae(`worker sent an error! ${_.filename}:${_.lineno}: ${_.message}`),_};var y,x=[];for(y of[])c.hasOwnProperty(y)&&x.push(y);d.postMessage({cmd:"load",handlers:x,wasmMemory:Ie,wasmModule:ie})});function Du(){var d=new Worker(new URL(import.meta.url),{type:"module",workerData:"em-pthread",name:"em-pthread"});gr.push(d)}var io=d=>{for(;0<d.length;)d.shift()(c)},Fx=()=>{var d=sn(),m=s()[d+52>>>2>>>0];d=s()[d+56>>>2>>>0],kl(m,m-d),bo(m)},Mx=(d,m)=>{Er=0,d=Dl(d,m),0<Er?Te=d:go(d)};class Vx{constructor(m){this.Ib=m-24}}function Gx(d,m,y){var x=new Vx(d>>>=0);throw m>>>=0,y>>>=0,s()[x.Ib+16>>>2>>>0]=0,s()[x.Ib+4>>>2>>>0]=m,s()[x.Ib+8>>>2>>>0]=y,d}function Bu(d,m,y,x){return g?He(2,1,d,m,y,x):Lu(d,m,y,x)}function Lu(d,m,y,x){if(d>>>=0,m>>>=0,y>>>=0,x>>>=0,T===void 0)return ae("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var _=[];return g&&_.length===0?Bu(d,m,y,x):(d={cc:y,Ab:d,Pb:x,ic:_},g?(d.Lb="spawnThread",postMessage(d,_),0):Au(d))}var Ru=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Nu=(d,m,y)=>{var x=(m>>>=0)+y;for(y=m;d[y]&&!(y>=x);)++y;if(16<y-m&&d.buffer&&Ru)return Ru.decode(d.buffer instanceof T?d.slice(m,y):d.subarray(m,y));for(x="";m<y;){var _=d[m++];if(128&_){var O=63&d[m++];if((224&_)==192)x+=String.fromCharCode((31&_)<<6|O);else{var R=63&d[m++];65536>(_=(240&_)==224?(15&_)<<12|O<<6|R:(7&_)<<18|O<<12|R<<6|63&d[m++])?x+=String.fromCharCode(_):(_-=65536,x+=String.fromCharCode(55296|_>>10,56320|1023&_))}}else x+=String.fromCharCode(_)}return x},rt=(d,m)=>(d>>>=0)?Nu(n(),d,m):"";function zu(d,m,y){return g?He(3,1,d,m,y):0}function Fu(d,m){if(g)return He(4,1,d,m)}var sa=d=>{for(var m=0,y=0;y<d.length;++y){var x=d.charCodeAt(y);127>=x?m++:2047>=x?m+=2:55296<=x&&57343>=x?(m+=4,++y):m+=3}return m},Mu=(d,m,y,x)=>{if(!(0<x))return 0;var _=y>>>=0;x=y+x-1;for(var O=0;O<d.length;++O){var R=d.charCodeAt(O);if(55296<=R&&57343>=R&&(R=65536+((1023&R)<<10)|1023&d.charCodeAt(++O)),127>=R){if(y>=x)break;m[y++>>>0]=R}else{if(2047>=R){if(y+1>=x)break;m[y++>>>0]=192|R>>6}else{if(65535>=R){if(y+2>=x)break;m[y++>>>0]=224|R>>12}else{if(y+3>=x)break;m[y++>>>0]=240|R>>18,m[y++>>>0]=128|R>>12&63}m[y++>>>0]=128|R>>6&63}m[y++>>>0]=128|63&R}}return m[y>>>0]=0,y-_},nn=(d,m,y)=>Mu(d,n(),m,y);function Vu(d,m){if(g)return He(5,1,d,m)}function Gu(d,m,y){if(g)return He(6,1,d,m,y)}function Uu(d,m,y){return g?He(7,1,d,m,y):0}function Wu(d,m){if(g)return He(8,1,d,m)}function Hu(d,m,y){if(g)return He(9,1,d,m,y)}function qu(d,m,y,x){if(g)return He(10,1,d,m,y,x)}function ju(d,m,y,x){if(g)return He(11,1,d,m,y,x)}function Ku(d,m,y,x){if(g)return He(12,1,d,m,y,x)}function Xu(d){if(g)return He(13,1,d)}function Zu(d,m){if(g)return He(14,1,d,m)}function Yu(d,m,y){if(g)return He(15,1,d,m,y)}var Ju,br,Ux=()=>{rn("")},Xt=d=>{for(var m="";n()[d>>>0];)m+=Ju[n()[d++>>>0]];return m},ua={},la={},Wx={};function lr(d,m,y={}){if(!("argPackAdvance"in m))throw new TypeError("registerType registeredInstance requires argPackAdvance");return function(x,_,O={}){var R=_.name;if(!x)throw new br(`type "${R}" must have a positive integer typeid pointer`);if(la.hasOwnProperty(x)){if(O.Rb)return;throw new br(`Cannot register type '${R}' twice`)}la[x]=_,delete Wx[x],ua.hasOwnProperty(x)&&(_=ua[x],delete ua[x],_.forEach(F=>F()))}(d,m,y)}var Qu=(d,m,y)=>{switch(m){case 1:return y?x=>e()[x>>>0]:x=>n()[x>>>0];case 2:return y?x=>t()[x>>>1>>>0]:x=>o()[x>>>1>>>0];case 4:return y?x=>i()[x>>>2>>>0]:x=>s()[x>>>2>>>0];case 8:return y?x=>Q[x>>>3]:x=>Se[x>>>3];default:throw new TypeError(`invalid integer width (${m}): ${d}`)}};function Hx(d,m,y){y>>>=0,lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:x=>x,toWireType:function(x,_){if(typeof _!="bigint"&&typeof _!="number")throw _=_===null?"null":(x=typeof _)=="object"||x==="array"||x==="function"?_.toString():""+_,new TypeError(`Cannot convert "${_}" to ${this.name}`);return typeof _=="number"&&(_=BigInt(_)),_},argPackAdvance:yr,readValueFromPointer:Qu(m,y,m.indexOf("u")==-1),Db:null})}var yr=8;function qx(d,m,y,x){lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:function(_){return!!_},toWireType:function(_,O){return O?y:x},argPackAdvance:yr,readValueFromPointer:function(_){return this.fromWireType(n()[_>>>0])},Db:null})}var ca=[],cr=[];function fa(d){9<(d>>>=0)&&--cr[d+1]==0&&(cr[d]=void 0,ca.push(d))}var Et=d=>{if(!d)throw new br("Cannot use deleted val. handle = "+d);return cr[d]},Ct=d=>{switch(d){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:let m=ca.pop()||cr.length;return cr[m]=d,cr[m+1]=1,m}};function da(d){return this.fromWireType(s()[d>>>2>>>0])}var jx={name:"emscripten::val",fromWireType:d=>{var m=Et(d);return fa(d),m},toWireType:(d,m)=>Ct(m),argPackAdvance:yr,readValueFromPointer:da,Db:null};function Kx(d){return lr(d>>>0,jx)}var Xx=(d,m)=>{switch(m){case 4:return function(y){return this.fromWireType(a()[y>>>2>>>0])};case 8:return function(y){return this.fromWireType(u()[y>>>3>>>0])};default:throw new TypeError(`invalid float width (${m}): ${d}`)}};function Zx(d,m,y){y>>>=0,lr(d>>>=0,{name:m=Xt(m>>>0),fromWireType:x=>x,toWireType:(x,_)=>_,argPackAdvance:yr,readValueFromPointer:Xx(m,y),Db:null})}function Yx(d,m,y,x,_){if(d>>>=0,y>>>=0,m=Xt(m>>>0),_===-1&&(_=4294967295),_=F=>F,x===0){var O=32-8*y;_=F=>F<<O>>>O}var R=m.includes("unsigned")?function(F,K){return K>>>0}:function(F,K){return K};lr(d,{name:m,fromWireType:_,toWireType:R,argPackAdvance:yr,readValueFromPointer:Qu(m,y,x!==0),Db:null})}function Jx(d,m,y){function x(O){var R=s()[O>>>2>>>0];return O=s()[O+4>>>2>>>0],new _(e().buffer,O,R)}var _=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][m];lr(d>>>=0,{name:y=Xt(y>>>0),fromWireType:x,argPackAdvance:yr,readValueFromPointer:x},{Rb:!0})}function Qx(d,m){d>>>=0;var y=(m=Xt(m>>>0))==="std::string";lr(d,{name:m,fromWireType:function(x){var _=s()[x>>>2>>>0],O=x+4;if(y)for(var R=O,F=0;F<=_;++F){var K=O+F;if(F==_||n()[K>>>0]==0){if(R=rt(R,K-R),Y===void 0)var Y=R;else Y+=String.fromCharCode(0),Y+=R;R=K+1}}else{for(Y=Array(_),F=0;F<_;++F)Y[F]=String.fromCharCode(n()[O+F>>>0]);Y=Y.join("")}return Yt(x),Y},toWireType:function(x,_){_ instanceof ArrayBuffer&&(_=new Uint8Array(_));var O=typeof _=="string";if(!(O||_ instanceof Uint8Array||_ instanceof Uint8ClampedArray||_ instanceof Int8Array))throw new br("Cannot pass non-string to std::string");var R=y&&O?sa(_):_.length,F=ho(4+R+1),K=F+4;if(s()[F>>>2>>>0]=R,y&&O)nn(_,K,R+1);else if(O)for(O=0;O<R;++O){var Y=_.charCodeAt(O);if(255<Y)throw Yt(K),new br("String has UTF-16 code units that do not fit in 8 bits");n()[K+O>>>0]=Y}else for(O=0;O<R;++O)n()[K+O>>>0]=_[O];return x!==null&&x.push(Yt,F),F},argPackAdvance:yr,readValueFromPointer:da,Db(x){Yt(x)}})}var el=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,e0=(d,m)=>{for(var y=d>>1,x=y+m/2;!(y>=x)&&o()[y>>>0];)++y;if(32<(y<<=1)-d&&el)return el.decode(n().slice(d,y));for(y="",x=0;!(x>=m/2);++x){var _=t()[d+2*x>>>1>>>0];if(_==0)break;y+=String.fromCharCode(_)}return y},t0=(d,m,y)=>{if(y??=2147483647,2>y)return 0;var x=m;y=(y-=2)<2*d.length?y/2:d.length;for(var _=0;_<y;++_){var O=d.charCodeAt(_);t()[m>>>1>>>0]=O,m+=2}return t()[m>>>1>>>0]=0,m-x},r0=d=>2*d.length,n0=(d,m)=>{for(var y=0,x="";!(y>=m/4);){var _=i()[d+4*y>>>2>>>0];if(_==0)break;++y,65536<=_?(_-=65536,x+=String.fromCharCode(55296|_>>10,56320|1023&_)):x+=String.fromCharCode(_)}return x},o0=(d,m,y)=>{if(m>>>=0,y??=2147483647,4>y)return 0;var x=m;y=x+y-4;for(var _=0;_<d.length;++_){var O=d.charCodeAt(_);if(55296<=O&&57343>=O&&(O=65536+((1023&O)<<10)|1023&d.charCodeAt(++_)),i()[m>>>2>>>0]=O,(m+=4)+4>y)break}return i()[m>>>2>>>0]=0,m-x},i0=d=>{for(var m=0,y=0;y<d.length;++y){var x=d.charCodeAt(y);55296<=x&&57343>=x&&++y,m+=4}return m};function a0(d,m,y){if(d>>>=0,m>>>=0,y=Xt(y>>>=0),m===2)var x=e0,_=t0,O=r0,R=F=>o()[F>>>1>>>0];else m===4&&(x=n0,_=o0,O=i0,R=F=>s()[F>>>2>>>0]);lr(d,{name:y,fromWireType:F=>{for(var K,Y=s()[F>>>2>>>0],ne=F+4,Pe=0;Pe<=Y;++Pe){var ke=F+4+Pe*m;Pe!=Y&&R(ke)!=0||(ne=x(ne,ke-ne),K===void 0?K=ne:(K+=String.fromCharCode(0),K+=ne),ne=ke+m)}return Yt(F),K},toWireType:(F,K)=>{if(typeof K!="string")throw new br(`Cannot pass non-string to C++ string type ${y}`);var Y=O(K),ne=ho(4+Y+m);return s()[ne>>>2>>>0]=Y/m,_(K,ne+4,Y+m),F!==null&&F.push(Yt,ne),ne},argPackAdvance:yr,readValueFromPointer:da,Db(F){Yt(F)}})}function s0(d,m){lr(d>>>=0,{Sb:!0,name:m=Xt(m>>>0),argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})}var u0=()=>1;function l0(d){va(d>>>0,!h,1,!b,131072,!1),Cu()}var tl=d=>{if(!je)try{if(d(),!(0<Er))try{g?go(Te):aa(Te)}catch(m){m instanceof na||m=="unwind"||E(1,m)}}catch(m){m instanceof na||m=="unwind"||E(1,m)}};function pa(d){d>>>=0,typeof Atomics.jc=="function"&&(Atomics.jc(i(),d>>>2,d).value.then(ao),d+=128,Atomics.store(i(),d>>>2,1))}var ao=()=>{var d=sn();d&&(pa(d),tl(Cl))};function c0(d,m){(d>>>=0)==m>>>0?setTimeout(ao):g?postMessage({targetThread:d,cmd:"checkMailbox"}):(d=Kt[d])&&d.postMessage({cmd:"checkMailbox"})}var ma=[];function f0(d,m,y,x,_){for(m>>>=0,x/=2,ma.length=x,y=_>>>0>>>3,_=0;_<x;_++)ma[_]=Q[y+2*_]?Q[y+2*_+1]:u()[y+2*_+1>>>0];return(m?ra[m]:ev[d])(...ma)}function d0(d){d>>>=0,g?postMessage({cmd:"cleanupThread",thread:d}):Eu(Kt[d])}function p0(d){}var ha=(d,m)=>{var y=la[d];if(y===void 0)throw d=Al(d),y=Xt(d),Yt(d),new br(`${m} has unknown type ${y}`);return y},rl=(d,m,y)=>{var x=[];return d=d.toWireType(x,y),x.length&&(s()[m>>>2>>>0]=Ct(x)),d};function m0(d,m,y){return m>>>=0,y>>>=0,d=Et(d>>>0),m=ha(m,"emval::as"),rl(m,y,d)}var so=d=>{try{d()}catch(m){rn(m)}},xr=0,Zt=null,nl=0,uo=[],ol={},il={},h0=0,ga=null,g0=[];function al(d){return function(m){if(!je){if(xr===0){var y=!1,x=!1;m((_=0)=>{if(!je&&(nl=_,y=!0,x)){xr=2,so(()=>Rl(Zt)),typeof Browser<"u"&&Browser.Jb.Qb&&Browser.Jb.resume(),_=!1;try{var O=function(){var K=i()[Zt+8>>>2>>>0];return K=te[il[K]],--Er,K()}()}catch(K){O=K,_=!0}var R=!1;if(!Zt){var F=ga;F&&(ga=null,(_?F.reject:F.resolve)(O),R=!0)}if(_&&!R)throw O}}),x=!0,y||(xr=1,Zt=function(){var _=ho(65548),O=_+12;s()[_>>>2>>>0]=O,s()[_+4>>>2>>>0]=O+65536,O=uo[0];var R=ol[O];return R===void 0&&(R=h0++,ol[O]=R,il[R]=O),O=R,i()[_+8>>>2>>>0]=O,_}(),typeof Browser<"u"&&Browser.Jb.Qb&&Browser.Jb.pause(),so(()=>Bl(Zt)))}else xr===2?(xr=0,so(Nl),Yt(Zt),Zt=null,g0.forEach(tl)):rn(`invalid state: ${xr}`);return nl}}(m=>{d().then(m)})}function b0(d){return d>>>=0,al(()=>(d=Et(d)).then(Ct))}var lo=[];function y0(d,m,y,x){return y>>>=0,x>>>=0,(d=lo[d>>>0])(null,m=Et(m>>>0),y,x)}var x0={},co=d=>{var m=x0[d];return m===void 0?Xt(d):m};function v0(d,m,y,x,_){return y>>>=0,x>>>=0,_>>>=0,(d=lo[d>>>0])(m=Et(m>>>0),m[y=co(y)],x,_)}var sl=()=>typeof globalThis=="object"?globalThis:Function("return this")();function w0(d){return(d>>>=0)==0?Ct(sl()):(d=co(d),Ct(sl()[d]))}var T0=d=>{var m=lo.length;return lo.push(d),m},_0=(d,m)=>{for(var y=Array(d),x=0;x<d;++x)y[x]=ha(s()[m+4*x>>>2>>>0],"parameter "+x);return y},ul=(d,m)=>Object.defineProperty(m,"name",{value:d});function I0(d,m,y){var x=(m=_0(d,m>>>0)).shift();d--;var _=`return function (obj, func, destructorsRef, args) {
...
`}
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${u}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:n,dataType:r.dataType}],dispatchGroup:{x:a},programUniforms:[{type:6,data:l}]}),getShaderSource:g}},cx=(r,e)=>{AI(r.inputs),r.compute(PI(r.inputs[0],e))},fx=r=>de({axis:r.axis})});var OI,EI,CI,kI,DI,px,mx,hx=C(()=>{"use strict";ue();ye();et();ge();OI=r=>{if(!r||r.length<1)throw new Error("too few inputs")},EI=(r,e)=>{let n=[],t=e.numOutputs;return r[1].dims[0]>0&&(r[1].getBigInt64Array().forEach(o=>n.push(Number(o))),t=n.length),de({numOutputs:t,axis:e.axis,splitSizes:n})},CI=r=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:e.cacheKey,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:l,dispatchGroup:{x:Math.ceil(t/64)},programUniforms:p})}},px=(r,e)=>{OI(r.inputs);let n=r.inputs.length===1?e:EI(r.inputs,e);r.compute(DI(r.inputs,n),{inputs:[0]})},mx=r=>{let e=r.axis,n=r.splitSizes,t=r.numOutputs<0?n.length:r.numOutputs;if(t!==n.length)throw new Error("numOutputs and splitSizes lengh must be equal");return de({axis:e,numOutputs:t,splitSizes:n})}});var BI,LI,gx,bx=C(()=>{"use strict";ue();ye();ge();BI=(r,e,n,t,o)=>{let i=V("output_data",o,n.length,4),s=D("a_data",e[1].dataType,e[1].dims.length,4),a=D("b_data",e[2].dataType,e[2].dims.length,4),u=D("c_data",e[0].dataType,e[0].dims.length,4),l,f=(c,p,b)=>`select(${p}, ${c}, ${b})`;if(!t)l=i.setByOffset("global_idx",f(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let c=(p,b,h="")=>{let g=`a_data[index_a${b}][component_a${b}]`,T=`b_data[index_b${b}][component_b${b}]`,w=`bool(c_data[index_c${b}] & (0xffu << (component_c${b} * 8)))`;return`
